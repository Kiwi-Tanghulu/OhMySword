...
public class PlayerView : MonoBehaviour
{
    ...
    public void RotateCamera(Vector2 vector)
    {
        ...
        hip.rotation = Quaternion.Euler(rotation.x, rotation.y, 0);
    ...
    public void SetRotation(Vector3 euler)
    {
        ...
        StartCoroutine(RotateCoroutine(hip, Quaternion.Euler(prevRotation.x, prevRotation.y, 0), Quaternion.Euler(targetRotation.x, targetRotation.y, 0)));
    }
