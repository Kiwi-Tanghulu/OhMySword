...
namespace Server
{
    public class ClientSession : Session
    {
        ...
        {
            Console.WriteLine($"[Session] Client Connected {{ Time : {DateTime.Now.ToString("MM.dd-HH:mm:ss")}, Address : {endPoint} }}");
        ...
        {
            Console.WriteLine($"[Session] Client Disconnected {{ Time : {DateTime.Now.ToString("MM.dd-HH:mm:ss")}, Address : {endPoint} }}");
