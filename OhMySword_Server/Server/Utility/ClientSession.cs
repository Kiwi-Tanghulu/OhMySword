...
namespace Server
{
    public class ClientSession : Session
    {
        ...
        {
            Console.WriteLine($"[Session] Client Connected {{ Time : {DateTime.Now}, Address : {endPoint} }}");
        ...
        {
            Console.WriteLine($"[Session] Client Disconnected {{ Time : {DateTime.Now}, Address : {endPoint} }}");
